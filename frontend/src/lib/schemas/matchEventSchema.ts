...
export type MatchEventRequestArray = z.infer<
  typeof matchEventRequestArraySchema
>;
...
export type CreateMatchEventsInput = z.infer<
  typeof createMatchEventsInputSchema
>;
